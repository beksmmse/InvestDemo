...
const situations = [
    ...
    "เกิดการประท้วงแรงงานในภาคพลังงาน การผลิตบางส่วนหยุดชะงัก",
...
const aiAdvices = [
    ...
    "แรงกดดันด้านอุปทานมักส่งผลต่อราคาพลังงานในระยะสั้น",
    "ปัจจัยบวก–ลบที่สวนทางกันอาจทำให้การตัดสินใจไม่ชัดเจน",
    "การจำกัดรายได้โดยตรงมักสะท้อนในราคาหุ้นอย่างรวดเร็ว",
    "การเติบโตที่มาพร้อมต้นทุน อาจทำให้มุมมองนักลงทุนแตกต่างกัน",
    "การเปลี่ยนแปลงดอกเบี้ยมักส่งผลต่อภาคการเงินโดยตรง",
    "มาตรการช่วยเหลืออาจลดผลกระทบได้ไม่เต็มที่",
    "สินค้าโภคภัณฑ์มักตอบสนองต่อความไม่แน่นอนเร็ว",
    "ความเห็นที่หลากหลายสะท้อนระดับความไม่แน่นอนสูง",
    "ข่าวเชิงบวกชัดเจนอาจกระตุ้นแรงซื้อระยะสั้น",
    "ผลลัพธ์สุดท้ายสะท้อนการตัดสินใจสะสมตลอดทั้งการทดลอง\nมากกว่าการเลือกเพียงรอบใดรอบหนึ่ง"
];
...
const fetchLeaderboard = () => {
    axios.get(`http://localhost:3000/api/leaderboard/Group3`)
        .then(res => {
